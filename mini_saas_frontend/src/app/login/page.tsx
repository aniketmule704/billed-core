          ...
          <div className="w-full max-w-sm space-y-6">
            <div className="text-center lg:text-left">
              <h2 className="text-2xl font-bold text-slate-900">
                {mode === "google" ? "Sign in to BillZo" : "Continue with phone"}
              </h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all"
                    />
                    <button
                      type="button"
            ...
            <div className="text-center mt-4">
              <button
                ...
                className="text-sm text-indigo-600 font-medium hover:underline"
              >
                {mode === "phone" ? "Use other sign-in methods" : "Sign in with phone instead"}
              </button>
            </div>
          </div>
        </div>
