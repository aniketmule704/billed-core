-- 054_fix_priority_cases_rpc_filter.sql
-- Relax the next_action_type filter in get_priority_cases RPC to include
-- review_payment and merchant_review cases that need merchant attention.
-- Previous versions (045, 046) only included send_reminder, call, follow_up_call.
