...
exports.buildAggregateInsights = buildAggregateInsights;
const WEEKDAYS = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
function buildAggregateInsights(metricsList, windowsList) {
    const insights = [];
...
//# sourceMappingURL=buildAggregateInsights.js.map