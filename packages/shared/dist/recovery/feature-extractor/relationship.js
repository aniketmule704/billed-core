...
exports.COMMUNICATION_PREFERENCES = exports.PREFERRED_ACTIONS = void 0;
exports.extractRelationshipFeatures = extractRelationshipFeatures;
exports.PREFERRED_ACTIONS = ['reminder', 'call', 'visit', 'escalate', 'wait'];
exports.COMMUNICATION_PREFERENCES = ['friendly', 'professional', 'urgent', 'unknown'];
function extractRelationshipFeatures(events) {
    ...
    for (const call of calls) {
        const hasPayment = payments.some(p => p.customerId === call.customerId &&
    ...
    for (const reminder of reminders) {
        const hasPayment = payments.some(p => p.customerId === reminder.customerId &&
